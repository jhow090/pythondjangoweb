...
urlpatterns = patterns('',
    ...
    url(r'^listar_disciplinaofertada', 'app.views.listar_discofer', name='listar_discofer'),
    url(r'^novo_disciplinaofertada', 'app.views.novo_discofer', name='novo_discofer'),
    url(r'^editar_disciplinaofertada/(?P<pk>\d+)$', 'app.views.editar_discofer', name='editar_discofer'),
    url(r'^apagar_disciplinaofertada/(?P<pk>\d+)$', 'app.views.apagar_discofer', name='apagar_discofer'),
