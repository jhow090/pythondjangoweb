...
urlpatterns = patterns('',
    ...
    url(r'^listar_discofer', 'app.views.listar_discofer', name='listar_discofer'),
    url(r'^novo_discofer', 'app.views.novo_discofer', name='novo_discofer'),
    url(r'^editar_discofer/(?P<pk>\d+)$', 'app.views.editar_discofer', name='editar_discofer'),
    url(r'^apagar_discofer/(?P<pk>\d+)$', 'app.views.apagar_discofer', name='apagar_discofer'),
